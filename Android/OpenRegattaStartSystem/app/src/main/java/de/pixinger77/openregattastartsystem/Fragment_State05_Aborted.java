...
public class Fragment_State05_Aborted extends Fragment_Base {

    private TextView txtTimer = null;

    public Fragment_State05_Aborted() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_state05__aborted, container, false);
    }
    ...
    protected void OnUpdateStatus(NetworkHelper.Status status) {
        NetworkHelper.StatusAborted castedStatus = (NetworkHelper.StatusAborted)status; // Casted to underlying type.
    }
}
