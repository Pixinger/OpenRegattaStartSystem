...
public class Fragment_State05_AbortedAll extends Fragment_Base {

    private TextView txtTimer = null;

    public Fragment_State05_AbortedAll() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_state05__aborted_all, container, false);
    }
    ...
    protected void OnUpdateStatus(NetworkHelper.Status status) {
        NetworkHelper.StatusAbortedAll castedStatus = (NetworkHelper.StatusAbortedAll)status; // Casted to underlying type.
    }
}
